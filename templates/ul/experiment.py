...
MODEL_CONFIGS = {
    ...
    # "google/gemma-2-2b": {"batch_size": 32, "dtype": "bfloat16", "layers": [3], "d_model": 16384},
    "google/gemma-2-2b": {"batch_size": 4, "dtype": "bfloat16", "layers": [12], "d_model": 65536},
}
...
if __name__ == "__main__":
    ...
    num_tokens = 200_000_000 # Set default number of tokens, can be increased by a factor of up to 10 but takes much longer. Note training steps = num_tokens/sae_batch_size, so you can increase training be increasing num_of_tokens
