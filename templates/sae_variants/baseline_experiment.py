...
# !!identical code as the experiment.py file, used to generate baseline results for various SAE variants like JumpReLU and TopK autoencoders.
...
def load_jumprelu_sae(repo_id: str, filename: str, layer: int) -> CustomSAE:
    ...
    sae = CustomSAE(params["W_enc"].shape[0], params["W_enc"].shape[1], layer)
...
if __name__ == "__main__":
    ...
    saes = []
    # # instead of training JumpReLU SAEs, we load pretrained ones since there are no standard JumpReLu trainer provided
    # for layer in layers:
