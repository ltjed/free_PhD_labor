...
class TrainerTopK(SAETrainer):
    ...
    def __init__(
        ...
        self.logging_parameters = ["effective_l0", "dead_features", "ortho_loss", "progress"]
        self.effective_l0 = -1
    ...
    def loss(self, x, step=None, logging=False):
        ...
        ortho_loss = torch.mean(torch.abs(feat_corr))
        # Scale by (1-p)^2 to reduce orthogonality constraint over time
        ortho_weight = (1 - progress) ** 2
