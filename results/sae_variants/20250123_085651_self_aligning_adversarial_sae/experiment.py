...
class CustomTrainer(SAETrainer):
    ...
    def loss(self, x, logging=False, **kwargs):
        ...
        self.ema_feature_sim.data = self.ema_decay * self.ema_feature_sim + (1 - self.ema_decay) * curr_mean
        self.ema_sim_std_dev.data = self.ema_decay * self.ema_sim_std_dev + (1 - self.ema_decay) * curr_std
