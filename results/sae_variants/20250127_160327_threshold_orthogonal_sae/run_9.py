...
class ThresholdOrthogonalTrainer(SAETrainer):
    ...
    def loss(self, x, logging=False, **kwargs):
        ...
        # Compute adaptive orthogonality loss with importance weighting
        ...
        # Dynamic threshold adjustment based on feature statistics
        feature_stats = torch.stack([freq_scores, importance_scores])
        ...
        # Apply combined scaling and threshold mask
