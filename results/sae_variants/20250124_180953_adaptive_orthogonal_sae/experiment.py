...
class OrthogonalSAE(nn.Module):
    ...
    def __init__(
        ...
        # Hyperparameters for orthogonality constraints
        self.tau = 0.1  # Fixed temperature parameter
    ...
    def get_top_pairs(self, features):
        """Select top-k feature pairs based on activation correlation."""
        B = features.size(0)  # Batch size
        F = features.size(1)  # Number of features
...
class OrthogonalTrainer(SAETrainer):
    ...
    def loss(self, x, logging=False, **kwargs):
        ...
        # Combined loss
        loss = l2_loss + self.l1_penalty * l1_loss + 0.1 * ortho_loss
