...
class CustomTrainer(SAETrainer):
    ...
    def loss(self, x, logging=False, **kwargs):
        ...
        # Adaptive orthogonality loss with controlled sharing (α=0.1)
        W = self.ae.W_enc
        ...
        alpha = 0.1  # Controlled sharing strength
        
        # Combined loss
        loss = l2_loss + self.l1_penalty * l1_loss + alpha * ortho_loss
    ...
    def config(self):
        return {
            ...
            'alpha': alpha,  # Log controlled sharing strength
        }
